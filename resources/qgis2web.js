...
map.getView().fit([8455937.158057, 989399.834308, 9624735.641757, 1641003.417617], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        var phrAttribution = document.createElement('li');
        phrAttribution.innerHTML = '<a href="https://tnphr.gov.in/">PHR</a> &middot; ';
        //var qgisAttribution = document.createElement('li');
        //qgisAttribution.innerHTML = '<a href="https://qgis.org/">QGIS</a>';
        //attributionList.insertBefore(qgis2webAttribution, firstLayerAttribution);
        attributionList.insertBefore(phrAttribution, firstLayerAttribution);
